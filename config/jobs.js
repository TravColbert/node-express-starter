...
module.exports = function (app) {
  ...
  for (const appInstance of app.locals.appList.split(',')) {
    const jobPath = path.join(__dirname, "..", app.locals.basePath, appInstance.trim(), app.locals.jobPath)

    app.locals.debug && console.debug(`Attempting load of job path: ${jobPath}...`)
  ...
  console.dir(app.locals.jobs, { depth: null })
}